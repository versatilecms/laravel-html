...
if (!function_exists('html')) {
    /**
     * @return Versatile\Html\HtmlBuilder
     */
    function html()
    {
        return app('html');
...
if (!function_exists('form')) {
    /**
     * @return Versatile\Html\FormBuilder
     */
    function form()
    {
        return app('form');
...
if (!function_exists('form_bootstrap')) {
    /**
     * @return Versatile\Html\Bootstrap\Bootstrap
     */
    function form_bootstrap()
    {
