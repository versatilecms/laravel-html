...
namespace Versatile\Html\Bootstrap;
...
use Versatile\Html\FormBuilder;
use Versatile\Html\HtmlBuilder;
...
class Bootstrap
{
     ...
     *
     * @var \Versatile\Html\HtmlBuilder
     */
    protected $html;
     ...
     *
     * @var \Versatile\Html\FormBuilder
     */
    protected $form;
     ...
     * Construct the class.
     *
     * @param  \Versatile\Html\HtmlBuilder $html
     * @param  \Versatile\Html\FormBuilder $form
    ...
    {
        return isset($this->type) ? $this->type : $this->config->get('html.bootstrap.type');
    }
    ...
    {
        return $this->leftColumnClass ?: $this->config->get('html.bootstrap.left_column_class');
    }
    ...
    {
        return $this->leftColumnOffsetClass ?: $this->config->get('html.bootstrap.left_column_offset_class');
    }
    ...
    {
        return $this->rightColumnClass ?: $this->config->get('html.bootstrap.right_column_class');
    }
    ...
    {
        return $this->iconPrefix ?: $this->config->get('html.bootstrap.icon_prefix');
    }
    ...
    {
        return $this->errorClass ?: $this->config->get('html.bootstrap.error_class');
    }
    ...
    {
        return $this->errorBag ?: $this->config->get('html.bootstrap.error_bag');
    }
