...
Disclaimer (pt_BR)
==========
Este repositório é uma versão modificada dos pacotes [laravelcollective/html](https://github.com/LaravelCollective/html) e [watson/bootstrap-form](https://github.com/dwightwatson/bootstrap-form). Algumas mudanças foram implementadas para uma melhor integração com as demais libs do projeto [Versatile](https://github.com/versatilecms).


<a name="installation"></a>
## Installation

Begin by installing this package through Composer. Edit your project's `composer.json` file to require `versatilelibs/laravel-html`.
...
```php
  'providers' => [
    // ...
    Versatile\Html\HtmlServiceProvider::class,
    // ...
  ],
```
...
```php
  'aliases' => [
    // ...
      'Form' => Versatile\Html\FormFacade::class,
      'Html' => Versatile\Html\HtmlFacade::class,
    // ...
  ],
```
...
use Versatile\Html\Eloquent\FormAccessible;
